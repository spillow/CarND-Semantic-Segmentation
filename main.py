...
def load_vgg(sess, vgg_path):
    ...
    input_im  = dg.get_tensor_by_name(vgg_input_tensor_name)
    keep_prob = dg.get_tensor_by_name(vgg_keep_prob_tensor_name)
    layer3    = dg.get_tensor_by_name(vgg_layer3_out_tensor_name)
    layer4    = dg.get_tensor_by_name(vgg_layer4_out_tensor_name)
    layer7    = dg.get_tensor_by_name(vgg_layer7_out_tensor_name)

    return input_im, keep_prob, layer3, layer4, layer7
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # skip layer
    conv_1x1 = conv1x1(vgg_layer4_out)
